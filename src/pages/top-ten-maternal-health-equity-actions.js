      ...
      <section className="mhea pp-main" id="meha">
        <div className="inner-content">
          ...
          <p>
            ...
            adopt these 10 actions, and join BCBS companies as we work toward a
          ...
          <div className="mhea-action mhea-action-two">
            ...
            <div className="mhea-action-content mhea-action-two-content">
              Provide access to cultural humility and unconscious bias training
              for everyone in the maternal care continuum.
            </div>
          </div>
          ...
          <div className="mhea-action mhea-action-five">
            ...
            <div className="mhea-action-content mhea-action-five-content">
              Implement facilitated self-management or peer prenatal care models
              such as CenteringPregnancy.<sup>TM</sup>
            </div>
          </div>
