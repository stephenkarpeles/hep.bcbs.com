          ...
          <Fade bottom cascade>
            <div className="disparities-cards">
              ...
              <div className="disparities-card disparities-card-behavioral">
                ...
                <div className="disparities-card-text">
                  Likely due to under-diagnosis, Millennials from majority Black
                  and Hispanic communities have lower diagnosis rates of major
                  depression, 31% and 55% lower respectively when compared to
                  white communities.
                </div>
                <div className="disparities-card-image">
                  <StaticImage
