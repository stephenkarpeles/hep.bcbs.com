    ...
    content: [
      <>
        <h3>
          ...
          Foundation Bridging the Gap program. Dr. Chin evaluates the value of
          the federally qualified health center program, improves diabetes
    ...
    content: [
      <>
        <h3>
          ...
          care to Latino women living in DC’s Ward 1. Under Gomez’s leadership,
          Mary’s Center has grown from an initial budget of $250,000, serving
          ...
          metropolitan region’s healthcare system. Prior to establishing Mary’s
          Center, Gomez was a public health nurse at the D.C. Department of
    ...
    content: [
      <>
        <h3>
          ...
          health inequity—racism. Dr. Hardeman leverages the frameworks of
